...
- **:whale2:Docker**：加入 Open WebUI Whisper 服務。

### 變更：
- **open-webui**：現在能夠合併環境變數以及 `config.json` 的值。
- **open-webui**：改為 SSL 認證。
...
- 修正 logo 不會正確顯示的問題。
- 修正 UMC GPT 不會產生標題的問題。([08f5ea9])

[08f5ea9]: https://github.com/CAkai/open-webui/commit/08f5ea9fb45e41edfaf328e39d8443edb500f308
